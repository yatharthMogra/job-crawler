...
from app.ingestion.enrichment_worker import cleanup_orphan_enrichment_queue, reset_stuck_queue_rows
...
@router.post("/enrichment/reset-stuck")
async def trigger_enrichment_reset_stuck(db: AsyncSession = Depends(get_db)) -> dict:
